...
INSTALLER UNDER HERE: https://github.com/Bazixv13/all-in-one/releases/tag/0.0.12
...
You can change preferences by opening config.py file using notepad

if program crashes change firston to False
